...
class Usuario {
    ...
    static async findAll(options = {}) {
        ...
        let query = `
            SELECT 
                id, name, email, usernick, photo_path, created_at, updated_at
            FROM vamusuario
        `;
    ...
    static async create(data) {
        ...
        const res = await pool.query(`
            INSERT INTO vamusuario (
                name, email, usernick, password, photo_path
            ) VALUES ($1, $2, $3, $4, $5)
            RETURNING id, name, email, usernick, photo_path, created_at, updated_at
        `, [
            data.name, 
            data.email, 
            data.usernick, 
    ...
    static async update(id, data) {
        ...
        query += ` WHERE id = $${params.length + 1} RETURNING id, name, email, usernick, photo_path, created_at, updated_at`;
        params.push(id);
